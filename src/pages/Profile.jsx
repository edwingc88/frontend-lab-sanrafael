        ...
        <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
          <div className='relative z-20 h-35 md:h-65'>
            <div className='absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4'>
              <label
                htmlFor='cover'
                className='flex cursor-pointer items-center justify-center gap-2 rounded bg-primary py-1 px-2 text-sm font-medium text-gray-500 hover:bg-opacity-80 xsm:px-4'
              >
          ...
          <div className='px-4 pb-6 text-center lg:pb-8 xl:pb-11.5'>
            <button className='absolute  bg-green-800 bottom-1 left-1 z-10 xsm:bottom-4 xsm:left-4'>EDIT</button>
            <div className='relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3'>
              ...
              <div className='relative drop-shadow-2'>
                ...
                <label
                  htmlFor='profile'
                  className='absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-primary text-gray-500 hover:bg-opacity-90 sm:bottom-2 sm:right-2'
                >
                  <svg
                    className='fill-current'
                    width='14'
            ...
            <div className='mt-4'>
              ...
              <p className='font-medium'>UserNamePedro</p>
              ...
              <div className='mt-6.5'>
                <h4 className='mb-3.5 font-medium text-black dark:text-gray-500'>
                  Follow me on
                </h4>
