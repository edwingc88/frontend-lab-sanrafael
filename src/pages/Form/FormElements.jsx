        ...
        <div className='flex flex-col gap-9'>
          ...
          <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
            <div className='border-b border-stroke py-4 px-6.5 dark:border-strokedark'>
              <h3 className='font-medium text-black dark:text-gray-500'>
                Input Fields
              </h3>
            </div>
            <div className='flex flex-col gap-5.5 p-6.5'>
              <div>
                <label className='mb-3 block text-black dark:text-gray-500'>
                  Default Input
                </label>
                <input
                  type='text'
              ...
              <div>
                <label className='mb-3 block font-medium text-black dark:text-gray-500'>
                  Disabled label
                </label>
                <input
                  type='text'
