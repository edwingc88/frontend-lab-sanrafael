...
const Calendar = () => {
  return (
    <>
      <Breadcrumb pageName='Orders Calendar' />

      {/* <!-- ====== Calendar Section Start ====== --> */}
      <div className='w-full max-w-full rounded-sm border border-stroke bg-blue-600 shadow-default dark:border-strokedark dark:bg-boxdark'>
        <table className='w-full'>
          ...
          <tbody>
            ...
            <tr className='grid grid-cols-7'>
              <td className='ease relative h-40 cursor-pointer border border-stroke p-2 transition duration-500 hover:bg-gray dark:border-strokedark dark:hover:bg-meta-4 md:h-25 md:p-6 xl:h-31'>
